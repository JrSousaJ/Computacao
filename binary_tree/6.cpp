...
void filhos(Arvore t,int val) 
{
    ...
    if(t->dir!=NULL)printf("Filho a direita eh igual a %d\n",t->dir->n);
    else if(t->dir==NULL)printf("Sem filho a direita\n");
    if(t->esq!=NULL)printf("Filho a esquerda eh igual a %d\n",t->esq->n);
    else if(t->esq==NULL)printf("Sem filho a esquerda\n");
}
int main()
{
    Arvore a = NULL;
